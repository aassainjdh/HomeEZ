        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="font-heading font-extrabold text-2xl tracking-tight bg-gradient-to-r from-primary-600 to-accent-600 bg-clip-text text-transparent dark:from-primary-400 dark:to-accent-400">
                HomeEZ
              </span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${
                isActive('/')
                  ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-slate-900/50'
            ...
            <button
              ...
              className="p-2 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white rounded-lg hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-all"
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 focus:outline-none p-1 rounded-full hover:bg-slate-100 dark:hover:bg-slate-900 transition-all"
                >
                  <img
                    src={user.profileImage || `https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(user.name)}`}
                    alt={user.name}
                    className="h-8 w-8 rounded-full object-cover border border-primary-500/20"
                  />
                ...
                {dropdownOpen && (
                  <>
                    ...
                    ></div>
                    <div className="absolute right-0 mt-2 w-48 rounded-xl bg-white dark:bg-dark-900 shadow-xl border border-slate-100 dark:border-slate-800/80 py-1.5 z-20 transition-all animate-in fade-in slide-in-from-top-2 duration-150">
              ...
              <div className="flex items-center space-x-2.5">
                <Link
                  to="/login"
                  className="px-4 py-2 rounded-lg text-sm font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-900/30 border border-slate-200 dark:border-slate-800 transition-all"
                >
                  Log In
                </Link>
                <Link
                  to="/register"
                  className="px-4 py-2 rounded-lg text-sm font-semibold bg-gradient-to-r from-primary-600 to-accent-600 hover:from-primary-700 hover:to-accent-700 text-white shadow-md hover:shadow-lg transition-all"
                >
                  Register
                </Link>
              </div>
          ...
          {!user && (
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex flex-col space-y-2 px-3">
              ...
              <Link
                to="/register"
                onClick={() => setIsOpen(false)}
                className="w-full text-center py-2.5 rounded-lg text-sm font-semibold bg-gradient-to-r from-primary-600 to-accent-600 text-white shadow-md"
              >
                Register
              </Link>
            </div>
